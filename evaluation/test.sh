...
TEST_DATA_DIR="$HOME/Projects/TF3/test-data"
LABELS_DIR="$TEST_DATA_DIR/labelsTr"
RESULTS_DIR="$HOME/Projects/TF3/test-results"
ALGORITHM_OUTPUT="$RESULTS_DIR/algorithm-output"
EVALUATION_OUTPUT="$RESULTS_DIR/evaluation-output"

echo "Running ToothFairy3 Multi-Instance-Segmentation evaluation $SCRIPT_DIR ..."
...
echo "Extracting ground truth tarball at $GT_EXTRACT_DIR..."
